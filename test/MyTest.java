...
class MyTest {
    ...
    // Test 1: Testing auto select based on corresponding number of spot choice selection
    @ParameterizedTest
    ...
    void autoPick_sizeAndRange(int spots) {
        Set<Integer> picks = game.autoPick(spots, new Random(12345));
    ...
    // Test 2: Testing randomness of the 20 number selection when drawing occurs
    @Test
    ...
    // Test 3: Testing number of matches
    @Test
    ...
    // Test 4: Testing number of matches where no matches should exist
    @Test
    ...
    // Test 5: Testing auto selection along with a drawing of 20
    @Test
